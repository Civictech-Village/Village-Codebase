    ...
    <div>
      <div data-custom-class="body">
        ...
        <div align="center" style={{ textAlign: "left" }}>
          ...
          >
            <bdt className="question">
              Our mission is to facilitate connection between community members,
              by giving them a platform to connect, discuss, and organize. By
              empowering individuals to come together, we aim to shift the focus
              from isolated struggles to collective efforts, enabling them to
              address common challenges and work towards shared goals.
            </bdt>
          </div>
          <div
            className="MsoNormal"
          ...
          >
            ...
            >
              ...
              phone at <bdt className="question">(+1)9179161024</bdt>, email at{" "}
              <bdt className="question">Christianps645@gmail.com</bdt>
              <bdt className="block-component" />,
              <bdt className="statement-end-if-in-editor" /> or by mail to{" "}
              <bdt className="question">
                882 3rd Ave, Brooklyn, NY 11232, USA
              </bdt>
              <bdt className="block-component" />,{" "}
              ...
              <bdt className="block-component" />
              <bdt className="block-component" />{" "}
              <bdt className="question">11232</bdt>
              <bdt className="statement-end-if-in-editor" />
              <bdt className="block-component" />
              <bdt className="block-component">,&nbsp;</bdt>
          ...
          >
            ...
            >
              ...
              <bdt className="statement-end-if-in-editor" />
              ), and <bdt className="question">Village</bdt>, concerning your
        ...
        <div align="center" style={{ textAlign: "left" }}>
          ...
          >
            ...
            >
              ...
              <bdt className="question">Christianps645@gmail.com</bdt>. If we
        ...
        <div align="center" style={{ textAlign: "left" }}>
          ...
          >
            <span style={{ fontSize: "15px" }}>
              ...
              <bdt className="statement-end-if-in-editor" />) shall be commenced
              ...
              <bdt className="block-component" />{" "}
              <bdt className="question">Kings</bdt>,
              <bdt className="statement-end-if-in-editor" />{" "}
              <bdt className="block-component" />
              ...
              than <bdt className="question">one (1)</bdt> years after the cause
              of action arose.
            </span>
            <bdt className="statement-end-if-in-editor">
              <span style={{ fontSize: "15px" }} />{" "}
              ...
              <strong>
                <strong>
                  ...
                  >
                    <strong>
                      <bdt className="block-component" />
                      Phone: <bdt className="question">(+1)9179161024</bdt>
                      <bdt className="statement-end-if-in-editor" />
                    </strong>
                  </span>
                </strong>
